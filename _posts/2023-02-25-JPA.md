...
```properties
spring.datasource.url=jdbc:sqlite:customers.sqlite // Se guarda en raíz del proyecto
...
* `spring.datasource.driver-class-name=org.sqlite.JDBC` se especifica en el código
...
* crear la aplicación, según el ejemplo.
  * Podemos hacer que la IA nos genere las entidades ya que es un trabajo tedioso.