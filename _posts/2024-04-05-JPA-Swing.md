...
```
Vemos como Spring automáticamente inyecta la clase `bookRepository` lo que nos obliga a pasárselo como parámetro a la ventana:
```java
package jpaswing;
...
Vamos a genera la navegación de los datos:
