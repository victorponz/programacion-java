...
![1548919314501](/programacion-java/assets/img/herencia/1548919314501.png)
...
> **NOTA**. En Java, los nombres de las interfaces suelen tener el sufijo `-able` o empezar por la letra `I`. Por ejemplo `Jugable` o `IJugar`, es decir, que sabe Jugar.
